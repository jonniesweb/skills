...
Run `bash <skill-dir>/move.sh [<source-worktree-path>]`. The script verifies both worktrees are clean, removes the source, checks the branch out in main, and prints a dev-server reminder.
